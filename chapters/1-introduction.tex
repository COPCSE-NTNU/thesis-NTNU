...
\paragraphheader{2. Background (p. X - Y | X number of pages)}
...
\paragraphheader{3. Related work (p. X - Y | X number of pages)}
...
\paragraphheader{4. Methodology (p. X - Y | X number of pages)}
...
\paragraphheader{5. Results (p. X - Y | X number of pages)}
...
\paragraphheader{6. Discussion (p. X - Y | X number of pages)}
