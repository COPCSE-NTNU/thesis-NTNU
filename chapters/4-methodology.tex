...
\begin{itemize}
    ...
    \item \textit{subsample} - fraction of samples from the training data considered when building each tree. Default is 1.0.
...
def random_search_cv(self, X, y, param_grid, folds=3):
    ...
    self.classifier.fit(X, y, early_stopping_rounds=10)
